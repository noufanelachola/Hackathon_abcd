      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <NavLink to="/" className="-m-1.5 p-1.5 text-sm font-semibold leading-6 text-gray-900">
            <span className="sr-only">ABCD Management System</span>
            <img className="h-8 w-auto float-left" src="/logo.png" alt="" />ABCD
          </NavLink>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a target='_blank' rel="noreferrer" href="https://github.com/noufanelachola" className="text-sm font-semibold leading-6 text-gray-900">
